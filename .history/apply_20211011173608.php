        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-6 my-3 jumbotron" style="margin-top:80px;">
                    ...
                    <?php 
                        if(isset($_SESSION['apply'])){
                            echo "<div class='text-center alert alert-danger' style='height:auto; font-size:12px'>$msgError</div>";
                        }else{
                            echo "<div class='text-center alert alert-danger' style='height:auto' hidden>$msgError</div>";
                        } ?>
